...
TRAIN = Path(f"results/logs/real/apple_cart_{RES}.log")
COOL = Path(f"results/logs/real/cd_cart_{RES}.log")
OUT = Path(f"results/runs/real/apple_b2cart_fixed_{RES}/cart_{RES}_4panel.png")
...
fig.suptitle(f"Apple b2 CARTÉSIEN (1 cam fixe, pose TCP) — {RES}px, R18+U-Net[512,1024,2048]+crop (bonne archi), "
