...
OUT = Path(f"results/runs/real/apple_b2_perf_128/b2_perf_4panel.png")
...
data = parse(TRAIN, 0) + parse(COOL, 40000)
if not data:
...
fig.suptitle(f"Apple b2 (1 caméra fixe, batch2 randomisé) — 128px 10Hz, R34+U-Net[256,512,1024] 86M, DDIM, "
