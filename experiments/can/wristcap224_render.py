...
Produit EN IMAGES (use_videos=False -> prêt gb10) et EN UN SEUL passage sim :
  - can_ph_proprio_224_img        : agentview seule            (bras A')
  - can_ph_proprio_wrist_224_img  : agentview + poignet        (bras B')
...
DS_AGENT = ("local/can_ph_proprio_224_img", Path("data_cache/lerobot_can_ph_proprio_224_img"))
DS_WRIST = ("local/can_ph_proprio_wrist_224_img", Path("data_cache/lerobot_can_ph_proprio_wrist_224_img"))
