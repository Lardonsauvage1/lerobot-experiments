"""
Expérience 41 — Lift : run 40 prolongé sur 500 epochs (test asymptote).

Run 40 a stabilisé test loss à 1.38 plat sur 100 epochs, success best
48% à epoch 25, final 200-eps eval 35%. L'overfit est cassé → on peut
maintenant entraîner plus longtemps sans crainte.

Question : success rate continue à monter (modèle apprend encore utile)
ou stagne sur un plateau ?

Identique à run 40 SAUF :
- EPOCHS = 500 (×5)
- Checkpoints à 25, 100, 200, 300, 400, 500 (6 points pour voir la courbe)
"""
...
# ============================================================
EXPERIMENT_NAME = "lift/41_lift_anti_overfit_long"
...
MAX_STEPS = 200
CHECKPOINT_EPOCHS = [25, 100, 200, 300, 400, 500]   # 6 points sur la durée 500 epochs
# ============================================================
